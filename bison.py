...
if __name__ == '__main__':
    ...
    model = create_optimization_model(instance, ocean_surface, ocean, detection_prob_rowsum_s, detection_prob, outdir)
    results = solve_model(model, instance, solver_name='glpk')  # or 'cplex', 'gurobi', etc.
    output_solution(model, instance, ocean_surface, ocean, detection_prob, outdir, start_time)
