...
DIR = "Instances/ChoctawhatcheeBay/" # directory where to find input and store output files

INPUT = "GMRTv3_3_20170611topo.asc" # file name of ocean floor data
OUTPUT = "ChoctawhatcheeBay" # name of output file (a time stamp will be added in front of this)

X = 20 # number of pixels in x-direction
Y = 8 # number of pixels in y-direction
