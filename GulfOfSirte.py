...
DIR = "Instances/GulfOfSirte/" # directory where to find input and store output files

INPUT = "GMRTv3_3_20170610topo.asc" # file name of ocean floor data
OUTPUT = "GulfOfSirte" # name of output file (a time stamp will be added in front of this)
