...
DIR = "Instances/GulfOfFinland/" # directory where to find input and store output files

INPUT = "GMRTv3_3_20170610topo.asc" # file name of ocean floor data
OUTPUT = "GulfOfFinland" # name of output file (a time stamp will be added in front of this)

X = 30 # number of pixels in x-direction
Y = 7 # number of pixels in y-direction
...
R = 5 # EITHER: cost for each deployed receiver (if GOAL=0), OR: number of deployed receivers (if GOAL=1)
