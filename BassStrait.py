...
DIR = "Instances/BassStrait/" # directory where to find input and store output files

INPUT = "GMRTv3_4_20171110topo.asc" # file name of ocean floor data
OUTPUT = "BassStrait" # name of output file (a time stamp will be added in front of this)
