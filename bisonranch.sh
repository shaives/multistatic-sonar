#!/bin/sh
#SBATCH --job-name multistatic-sonar-gu
#SBATCH --array=0-4                             # How many different jobs do you want to run? You probably want 1.
...
#SBATCH --mem=32GB                              # How much memory do you want total? (You can use suffixes: M=MB, G=GB, T=TB.)
...
ARGS=(Agadir EnglishChannel MontereyPeninsular OpenSeaBiscaya0 OpenSeaBiscaya1)
