...
DIR = "Instances/OpenSea-Biscaya/" # directory where to find input and store output files

INPUT = "GMRTv3_3_20170615topo.asc" # file name of ocean floor data
OUTPUT = "OpenSea-Biscaya" # name of output file (a time stamp will be added in front of this)
