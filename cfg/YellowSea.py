...
DIR = "Instances/YellowSea/" # directory where to find input and store output files

INPUT = "GMRTv3_5_20180731topo.asc" # file name of ocean floor data
OUTPUT = "YellowSea" # name of output file (a time stamp will be added in front of this)

X = 17 # number of pixels in x-direction
Y = 17 # number of pixels in y-direction
...
R = 6 # EITHER: cost for each deployed receiver (if GOAL=0), OR: number of deployed receivers (if GOAL=1)
