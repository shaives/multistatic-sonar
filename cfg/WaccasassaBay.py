...
DIR = "Instances/WaccasassaBay/" # directory where to find input and store output files

INPUT = "GMRTv3_4_20171110topo.asc" # file name of ocean floor data
OUTPUT = "WaccasassaBay" # name of output file (a time stamp will be added in front of this)

X = 14 # number of pixels in x-direction
Y = 13 # number of pixels in y-direction
