...
DIR = "Instances/GulfOfAkaba/" # directory where to find input and store output files

INPUT = "GMRTv3_3_20170610topo.asc" # file name of ocean floor data
OUTPUT = "GulfOfAkaba" # name of output file (a time stamp will be added in front of this)

X = 7 # number of pixels in x-direction
Y = 16 # number of pixels in y-direction
