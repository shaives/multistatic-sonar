...
DIR = "Instances/TaedongGang/" # directory where to find input and store output files

INPUT = "GMRTv3_3_20170611topo.asc" # file name of ocean floor data
OUTPUT = "TaedongGang" # name of output file (a time stamp will be added in front of this)
