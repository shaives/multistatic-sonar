...
DIR = "Instances/Storebaelt/" # directory where to find input and store output files

INPUT = "GMRTv3_3_20170610topo.asc" # file name of ocean floor data
OUTPUT = "Storebaelt" # name of output file (a time stamp will be added in front of this)

X = 9 # number of pixels in x-direction
Y = 18 # number of pixels in y-direction
