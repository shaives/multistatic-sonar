...
DIR = "Instances/Falklandsund/" # directory where to find input and store output files

INPUT = "GMRTv3_3_20170611topo.asc" # file name of ocean floor data
OUTPUT = "Falklandsund" # name of output file (a time stamp will be added in front of this)
...
R = 10 # EITHER: cost for each deployed receiver (if GOAL=0), OR: number of deployed receivers (if GOAL=1)
