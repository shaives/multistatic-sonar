...
DIR = "Instances/Smalandsfarvandet/" # directory where to find input and store output files

INPUT = "GMRTv3_3_20170610topo.asc" # file name of ocean floor data
OUTPUT = "Smalandsfarvandet" # name of output file (a time stamp will be added in front of this)

X = 19 # number of pixels in x-direction
